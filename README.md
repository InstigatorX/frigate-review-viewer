...
2. Copy build_frigate_day_log.py to the /config directory. You'll need to edit the API IP addresses to suit your environment. 192.168.86.243 is my primary Frigate where the reviews are pull and 192.168.86.244 is my record-only secondary server.
